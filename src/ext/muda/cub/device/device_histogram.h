...
class DeviceHistogram : public CubWrapper<DeviceHistogram>
{
  public:
    ...
    DeviceHistogram& HistogramEven(device_buffer<std::byte>& external_buffer,
    ...
    DeviceHistogram& MultiHistogramEven(device_buffer<std::byte>& external_buffer,
                                        SampleIteratorT d_samples,
    ...
    template <typename SampleIteratorT, typename CounterT, typename LevelT, typename OffsetT>
    DeviceHistogram& HistogramRange(device_buffer<std::byte>& external_buffer,
                                    SampleIteratorT           d_samples,
                                    CounterT*                 d_histogram,
                                    int                       num_levels,
                                    LevelT*                   d_levels,
    ...
    template <int NUM_CHANNELS, int NUM_ACTIVE_CHANNELS, typename SampleIteratorT, typename CounterT, typename LevelT, typename OffsetT>
    DeviceHistogram& MultiHistogramRange(device_buffer<std::byte>& external_buffer,
                                         SampleIteratorT d_samples,
                                         CounterT* d_histogram[NUM_ACTIVE_CHANNELS],
                                         int num_levels[NUM_ACTIVE_CHANNELS],
