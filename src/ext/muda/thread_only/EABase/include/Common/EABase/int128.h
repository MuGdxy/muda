...
struct EA_INT128_ALIGNAS int128_t_base
{
    ...
    MUDA_THREAD_ONLY int128_t_base() = default;
    MUDA_THREAD_ONLY int128_t_base(uint32_t nPart0, uint32_t nPart1, uint32_t nPart2, uint32_t nPart3);
    MUDA_THREAD_ONLY int128_t_base(uint64_t nPart0, uint64_t nPart1);
    MUDA_THREAD_ONLY int128_t_base(uint8_t value);
    MUDA_THREAD_ONLY int128_t_base(uint16_t value);
    MUDA_THREAD_ONLY int128_t_base(uint32_t value);
    MUDA_THREAD_ONLY int128_t_base(uint64_t value);
    MUDA_THREAD_ONLY int128_t_base(const int128_t_base& value) = default;

    // Assignment operator
    MUDA_THREAD_ONLY int128_t_base& operator=(const int128_t_base& value) = default;

    // Explicit operators to convert back to basic types
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator bool() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator char() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator int() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator long() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator long long() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator short() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator signed char() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned char() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned int() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned long long() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned long() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned short() const;
#if EA_WCHAR_UNIQUE
...
#endif
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator float() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator double() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator long double() const;
#if EA_INT128_INTRINSIC_AVAILABLE
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator __int128() const;
    MUDA_THREAD_ONLY EA_CONSTEXPR explicit operator unsigned __int128() const;
#endif

    // Math operators
    MUDA_THREAD_ONLY static void OperatorPlus(const int128_t_base& value1,
                                              const int128_t_base& value2,
                                              int128_t_base&       result);
    MUDA_THREAD_ONLY static void OperatorMinus(const int128_t_base& value1,
                                               const int128_t_base& value2,
                                               int128_t_base&       result);
    MUDA_THREAD_ONLY static void OperatorMul(const int128_t_base& value1,
                                             const int128_t_base& value2,
                                             int128_t_base&       result);

    // Shift operators
    MUDA_THREAD_ONLY static void OperatorShiftRight(const int128_t_base& value,
                                                    int                  nShift,
                                                    int128_t_base& result);
    MUDA_THREAD_ONLY static void OperatorShiftLeft(const int128_t_base& value,
                                                   int                  nShift,
                                                   int128_t_base&       result);

    // Unary arithmetic/logic operators
    MUDA_THREAD_ONLY bool operator!() const;

    // Logical operators
    MUDA_THREAD_ONLY static void OperatorXOR(const int128_t_base& value1,
                                             const int128_t_base& value2,
                                             int128_t_base&       result);
    MUDA_THREAD_ONLY static void OperatorOR(const int128_t_base& value1,
                                            const int128_t_base& value2,
                                            int128_t_base&       result);
    MUDA_THREAD_ONLY static void OperatorAND(const int128_t_base& value1,
                                             const int128_t_base& value2,
                                             int128_t_base&       result);

    MUDA_THREAD_ONLY bool IsZero() const;
    MUDA_THREAD_ONLY void SetZero();
    MUDA_THREAD_ONLY void TwosComplement();
    MUDA_THREAD_ONLY void InverseTwosComplement();

    MUDA_THREAD_ONLY int  GetBit(int nIndex) const;
    MUDA_THREAD_ONLY void SetBit(int nIndex, int value);

  protected:
    MUDA_THREAD_ONLY void DoubleToUint128(double value);

    MUDA_THREAD_ONLY EA_CONSTEXPR uint64_t Low() const { return mPart0; }

    MUDA_THREAD_ONLY EA_CONSTEXPR uint64_t High() const { return mPart1; }
...
struct int128_t : public int128_t_base
{
    ...
    // Unary arithmetic/logic operators
    MUDA_THREAD_ONLY int128_t  operator-() const;
    MUDA_THREAD_ONLY int128_t& operator++();
    MUDA_THREAD_ONLY int128_t& operator--();
    MUDA_THREAD_ONLY int128_t  operator++(int);
    MUDA_THREAD_ONLY int128_t  operator--(int);
    MUDA_THREAD_ONLY int128_t  operator~() const;
    MUDA_THREAD_ONLY int128_t  operator+() const;

    // Math operators
    MUDA_THREAD_ONLY int128_t  operator+(const int128_t& other);
    MUDA_THREAD_ONLY int128_t  operator-(const int128_t& other);
    MUDA_THREAD_ONLY int128_t  operator*(const int128_t& other);
    MUDA_THREAD_ONLY int128_t  operator/(const int128_t& other);
    MUDA_THREAD_ONLY int128_t  operator%(const int128_t& other);
    ...
    // Shift operators
    MUDA_THREAD_ONLY int128_t  operator>>(int nShift) const;
    MUDA_THREAD_ONLY int128_t  operator<<(int nShift) const;
    MUDA_THREAD_ONLY int128_t& operator>>=(int nShift);
    MUDA_THREAD_ONLY int128_t& operator<<=(int nShift);

    // Logical operators
    MUDA_THREAD_ONLY int128_t  operator^(const int128_t& other) const;
    MUDA_THREAD_ONLY int128_t  operator|(const int128_t& other) const;
    MUDA_THREAD_ONLY int128_t  operator&(const int128_t& other) const;
    MUDA_THREAD_ONLY int128_t& operator^=(const int128_t& other);
    MUDA_THREAD_ONLY int128_t& operator|=(const int128_t& other);
    ...
    // Equality operators
    MUDA_THREAD_ONLY bool operator==(const int128_t& other) const;
    MUDA_THREAD_ONLY bool operator!=(const int128_t& other) const;
    MUDA_THREAD_ONLY bool operator>(const int128_t& other) const;
    MUDA_THREAD_ONLY bool operator>=(const int128_t& other) const;
    MUDA_THREAD_ONLY bool operator<(const int128_t& other) const;
  ...
  protected:
    MUDA_THREAD_ONLY int  compare(const int128_t& other) const;
    MUDA_THREAD_ONLY void Negate();
    MUDA_THREAD_ONLY void Modulus(const int128_t& divisor,
                                  int128_t&       quotient,
                                  int128_t&       remainder) const;
    MUDA_THREAD_ONLY bool IsNegative() const;  // Returns true for value <  0
    MUDA_THREAD_ONLY bool IsPositive() const;  // Returns true for value >= 0
};
...
struct uint128_t : public int128_t_base
{
    ...
    // Unary arithmetic/logic operators
    MUDA_THREAD_ONLY uint128_t  operator-() const;
    MUDA_THREAD_ONLY uint128_t& operator++();
    MUDA_THREAD_ONLY uint128_t& operator--();
    MUDA_THREAD_ONLY uint128_t  operator++(int);
    MUDA_THREAD_ONLY uint128_t  operator--(int);
    MUDA_THREAD_ONLY uint128_t  operator~() const;
    MUDA_THREAD_ONLY uint128_t  operator+() const;

    // Math operators
    MUDA_THREAD_ONLY uint128_t  operator+(const uint128_t& other);
    MUDA_THREAD_ONLY uint128_t  operator-(const uint128_t& other);
    MUDA_THREAD_ONLY uint128_t  operator*(const uint128_t& other);
    MUDA_THREAD_ONLY uint128_t  operator/(const uint128_t& other);
    MUDA_THREAD_ONLY uint128_t  operator%(const uint128_t& other);
    ...
    // Shift operators
    MUDA_THREAD_ONLY uint128_t  operator>>(int nShift) const;
    MUDA_THREAD_ONLY uint128_t  operator<<(int nShift) const;
    MUDA_THREAD_ONLY uint128_t& operator>>=(int nShift);
    MUDA_THREAD_ONLY uint128_t& operator<<=(int nShift);

    // Logical operators
    MUDA_THREAD_ONLY uint128_t  operator^(const uint128_t& other) const;
    MUDA_THREAD_ONLY uint128_t  operator|(const uint128_t& other) const;
    MUDA_THREAD_ONLY uint128_t  operator&(const uint128_t& other) const;
    MUDA_THREAD_ONLY uint128_t& operator^=(const uint128_t& other);
    MUDA_THREAD_ONLY uint128_t& operator|=(const uint128_t& other);
    ...
    // Equality operators
    MUDA_THREAD_ONLY bool operator==(const uint128_t& other) const;
    MUDA_THREAD_ONLY bool operator!=(const uint128_t& other) const;
    MUDA_THREAD_ONLY bool operator>(const uint128_t& other) const;
    MUDA_THREAD_ONLY bool operator>=(const uint128_t& other) const;
    MUDA_THREAD_ONLY bool operator<(const uint128_t& other) const;
  ...
  protected:
    MUDA_THREAD_ONLY int  compare(const uint128_t& other) const;
    MUDA_THREAD_ONLY void Negate();
    MUDA_THREAD_ONLY void Modulus(const uint128_t& divisor,
                                  uint128_t&       quotient,
...
inline bool int128_t::operator!=(const int128_t& other) const
{
    return (mPart0 != other.mPart0)
           ||  // Check mPart0 first as this will likely yield faster execution.
           (mPart1 != other.mPart1);
}
...
// would work.
//
/* EA_CONSTEXPR */ MUDA_THREAD_ONLY inline uint128_t UINT128_C(uint64_t nPart1, uint64_t nPart0)
{
    return uint128_t(nPart0, nPart1);
}
/* EA_CONSTEXPR */ MUDA_THREAD_ONLY inline int128_t INT128_C(int64_t nPart1, int64_t nPart0)
{
