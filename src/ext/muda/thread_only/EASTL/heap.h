...
MUDA_THREAD_ONLY inline void promote_heap_impl(RandomAccessIterator first,
    ...
    MUDA_THREAD_ONLY inline void promote_heap(RandomAccessIterator first,
                                              Distance             topPosition,
                                              Distance             position,
                                              const T&             value)
	{
	...
	template <typename RandomAccessIterator, typename Distance, typename T, typename ValueType>
    MUDA_THREAD_ONLY void adjust_heap_impl(RandomAccessIterator first,
                                           Distance             topPosition,
                                           Distance             heapSize,
                                           Distance             position,
                                           T                    value)
	...
	///
	template <typename RandomAccessIterator, typename Distance, typename T>
    MUDA_THREAD_ONLY void adjust_heap(RandomAccessIterator first,
                                      Distance             topPosition,
                                      Distance             heapSize,
                                      Distance             position,
                                      const T&             value)
    ...
    MUDA_THREAD_ONLY inline void push_heap(RandomAccessIterator first, RandomAccessIterator last)
	{
    ...
    MUDA_THREAD_ONLY inline void push_heap(RandomAccessIterator first,
	...
	///
	template <typename RandomAccessIterator>
    MUDA_THREAD_ONLY inline void pop_heap(RandomAccessIterator first, RandomAccessIterator last)
	{
		typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type difference_type;
		typedef typename eastl::iterator_traits<RandomAccessIterator>::value_type      value_type;
	...
	///
	template <typename RandomAccessIterator, typename Compare>
    MUDA_THREAD_ONLY inline void pop_heap(RandomAccessIterator first,
                                          RandomAccessIterator last,
                                          Compare              compare)
	{
		typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type difference_type;
	...
	///
	template <typename RandomAccessIterator>
    MUDA_THREAD_ONLY void make_heap(RandomAccessIterator first, RandomAccessIterator last)
	{
	...
	template <typename RandomAccessIterator, typename Compare>
    MUDA_THREAD_ONLY void make_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare)
	{
		typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type difference_type;
		typedef typename eastl::iterator_traits<RandomAccessIterator>::value_type      value_type;
	...
	///
	template <typename RandomAccessIterator>
    MUDA_THREAD_ONLY inline void sort_heap(RandomAccessIterator first, RandomAccessIterator last)
	{
	...
	///
	template <typename RandomAccessIterator, typename Compare>
    MUDA_THREAD_ONLY inline void sort_heap(RandomAccessIterator first,
                                           RandomAccessIterator last,
                                           Compare              compare)
	{
		for(; (last - first) > 1; --last) // We simply use the heap to sort itself.
    ...
    MUDA_THREAD_ONLY inline void remove_heap(RandomAccessIterator first,
                                             Distance             heapSize,
                                             Distance             position)
	{
		typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type difference_type;
	...
	///
	template <typename RandomAccessIterator, typename Distance>
    MUDA_THREAD_ONLY inline void change_heap(RandomAccessIterator first,
                                             Distance             heapSize,
                                             Distance             position)
	{
		typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type difference_type;
	...
	///
	template <typename RandomAccessIterator>
    MUDA_THREAD_ONLY inline RandomAccessIterator is_heap_until(RandomAccessIterator first,
                                                               RandomAccessIterator last)
	{
		int counter = 0;
	...
	///
	template <typename RandomAccessIterator>
    MUDA_THREAD_ONLY inline bool is_heap(RandomAccessIterator first, RandomAccessIterator last)
	{
	...
	///
	template <typename RandomAccessIterator, typename Compare>
    MUDA_THREAD_ONLY inline bool is_heap(RandomAccessIterator first,
                                         RandomAccessIterator last,
                                         Compare              compare)
	{
