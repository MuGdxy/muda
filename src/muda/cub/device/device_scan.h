...
class DeviceScan : public CubWrapper<DeviceScan>
{
  public:
    ...
    DeviceScan& InclusiveScan(void*           d_temp_storage,
                              ...
                              int             num_items)
    {
        checkCudaErrors(cub::DeviceScan::InclusiveScan(
            d_temp_storage, temp_storage_bytes, d_in, d_out, scan_op, num_items, this->stream(), false));
    }
    ...
    DeviceScan& ExclusiveSumByKey(void*                 d_temp_storage,
                                  ...
                                  EqualityOpT equality_op = EqualityOpT())
    {
        checkCudaErrors(cub::DeviceScan::ExclusiveSumByKey(d_temp_storage,
                                                           temp_storage_bytes,
                                                           d_keys_in,
                                                           d_values_in,
                                                           d_values_out,
    ...
    DeviceScan& ExclusiveScanByKey(void*                 d_temp_storage,
                                   ...
                                   EqualityOpT equality_op = EqualityOpT())
    {
        checkCudaErrors(cub::DeviceScan::ExclusiveScanByKey(d_temp_storage,
                                                            temp_storage_bytes,
                                                            d_keys_in,
                                                            d_values_in,
                                                            d_values_out,
    ...
    DeviceScan& InclusiveSumByKey(void*                 d_temp_storage,
                                  ...
                                  EqualityOpT equality_op = EqualityOpT())
    {
        checkCudaErrors(cub::DeviceScan::InclusiveSumByKey(d_temp_storage,
                                                           temp_storage_bytes,
                                                           d_keys_in,
                                                           d_values_in,
                                                           d_values_out,
    ...
    DeviceScan& InclusiveScanByKey(void*                 d_temp_storage,
                                   ...
                                   EqualityOpT equality_op = EqualityOpT())
    {
        checkCudaErrors(cub::DeviceScan::InclusiveScanByKey(d_temp_storage,
                                                            temp_storage_bytes,
                                                            d_keys_in,
                                                            d_values_in,
                                                            d_values_out,
