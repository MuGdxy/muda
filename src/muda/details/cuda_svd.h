...
namespace details
{
    __device__ const auto gone                  = 1065353216;
    __device__ const auto gsine_pi_over_eight   = 1053028117;
    __device__ const auto gcosine_pi_over_eight = 1064076127;
    __device__ const auto gone_half             = 0.5f;
    __device__ const auto gsmall_number         = 1.e-12f;
    __device__ const auto gtiny_number          = 1.e-20f;
    __device__ const auto gfour_gamma_squared   = 5.8284273147583007813f;
