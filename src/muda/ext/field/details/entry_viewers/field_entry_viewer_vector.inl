...
class FieldEntryViewerBase<IsConst, T, Layout, N, 1>
    : public FieldEntryViewerCore<IsConst, T, Layout, N, 1>
{
    using Base = FieldEntryViewerCore<IsConst, T, Layout, N, 1>;
  ...
  public:
    using Base::Base;
    using ConstViewer    = FieldEntryViewerBase<true, T, Layout, N, 1>;
    using NonConstViewer = FieldEntryViewerBase<false, T, Layout, N, 1>;
    using ThisViewer     = FieldEntryViewerBase<IsConst, T, Layout, N, 1>;
...
class CFieldEntryViewer<T, Layout, N, 1>
    : public FieldEntryViewerBase<true, T, Layout, N, 1>
{
    using Base = FieldEntryViewerBase<true, T, Layout, N, 1>;

    MUDA_VIEWER_COMMON_NAME(CFieldEntryViewer);

  public:
    using Base::Base;
    using ConstViewer    = CFieldEntryViewer<T, Layout, N, 1>;
    using NonConstViewer = FieldEntryViewer<T, Layout, N, 1>;
    using ThisViewer     = CFieldEntryViewer<T, Layout, N, 1>;
...
template <typename T, FieldEntryLayout Layout, int N>
class FieldEntryViewer<T, Layout, N, 1>
    : public FieldEntryViewerBase<false, T, Layout, N, 1>
{
    using Base = FieldEntryViewerBase<false, T, Layout, N, 1>;
  ...
  public:
    ...
    using ConstViewer    = CFieldEntryViewer<T, Layout, N, 1>;
    using NonConstViewer = FieldEntryViewer<T, Layout, N, 1>;
    using ThisViewer     = FieldEntryViewer<T, Layout, N, 1>;
