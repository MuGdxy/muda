...
MUDA_THREAD_ONLY ForwardIterator min_element(ForwardIterator first, ForwardIterator last)
{
    if(first != last)
    {
...
MUDA_THREAD_ONLY ForwardIterator min_element(ForwardIterator first, ForwardIterator last, Compare compare)
{
    if(first != last)
    {
        ForwardIterator currentMin = first;
...
///
template <typename ForwardIterator>
MUDA_THREAD_ONLY ForwardIterator max_element(ForwardIterator first, ForwardIterator last)
{
    if(first != last)
    {
...
///
template <typename ForwardIterator, typename Compare>
MUDA_THREAD_ONLY ForwardIterator max_element(ForwardIterator first, ForwardIterator last, Compare compare)
{
    if(first != last)
    {
        ForwardIterator currentMax = first;
...
///
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<eastl::is_scalar<T>::value, T>::type min(
    T a, T b)
{
    return b < a ? b : a;
}
...
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<!eastl::is_scalar<T>::value, const T&>::type min(
    const T& a, const T& b)
{
    return b < a ? b : a;
}

MUDA_THREAD_ONLY inline EA_CONSTEXPR float min(float a, float b)
{
    return b < a ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR double min(double a, double b)
{
    return b < a ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR long double min(long double a, long double b)
{
    return b < a ? b : a;
}
...
///
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<eastl::is_scalar<T>::value, T>::type min_alt(
    T a, T b)
{
    return b < a ? b : a;
}
...
template <typename T>
MUDA_THREAD_ONLY inline typename eastl::enable_if<!eastl::is_scalar<T>::value, const T&>::type min_alt(
    const T& a, const T& b)
{
    return b < a ? b : a;
}

MUDA_THREAD_ONLY inline EA_CONSTEXPR float min_alt(float a, float b)
{
    return b < a ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR double min_alt(double a, double b)
{
    return b < a ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR long double min_alt(long double a, long double b)
{
    return b < a ? b : a;
}
...
MUDA_THREAD_ONLY inline const T& min(const T& a, const T& b, Compare compare)
{
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY inline const T& min_alt(const T& a, const T& b, Compare compare)
{
    return compare(b, a) ? b : a;
}
...
///
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<eastl::is_scalar<T>::value, T>::type max(
    T a, T b)
{
    return a < b ? b : a;
}
...
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<!eastl::is_scalar<T>::value, const T&>::type max(
    const T& a, const T& b)
{
    return a < b ? b : a;
}

MUDA_THREAD_ONLY inline EA_CONSTEXPR float max(float a, float b)
{
    return a < b ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR double max(double a, double b)
{
    return a < b ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR long double max(long double a, long double b)
{
    return a < b ? b : a;
}
...
///
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<eastl::is_scalar<T>::value, T>::type max_alt(
    T a, T b)
{
    return a < b ? b : a;
}
...
template <typename T>
MUDA_THREAD_ONLY inline EA_CONSTEXPR typename eastl::enable_if<!eastl::is_scalar<T>::value, const T&>::type max_alt(
    const T& a, const T& b)
{
    return a < b ? b : a;
}

MUDA_THREAD_ONLY inline EA_CONSTEXPR float max_alt(float a, float b)
{
    return a < b ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR double max_alt(double a, double b)
{
    return a < b ? b : a;
}
MUDA_THREAD_ONLY inline EA_CONSTEXPR long double max_alt(long double a, long double b)
{
    return a < b ? b : a;
}
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY inline const T& max(const T& a, const T& b, Compare compare)
{
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY inline const T& max_alt(const T& a, const T& b, Compare compare)
{
    return compare(a, b) ? b : a;
}
...
///
template <typename T>
MUDA_THREAD_ONLY T min(std::initializer_list<T> ilist)
{
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY T min(std::initializer_list<T> ilist, Compare compare)
{
...
///
template <typename T>
MUDA_THREAD_ONLY T max(std::initializer_list<T> ilist)
{
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY T max(std::initializer_list<T> ilist, Compare compare)
{
...
///
template <typename ForwardIterator, typename Compare>
MUDA_THREAD_ONLY eastl::pair<ForwardIterator, ForwardIterator> minmax_element(
...
template <typename T>
MUDA_THREAD_ONLY inline eastl::pair<const T&, const T&> minmax(const T& a, const T& b)
{
    return (b < a) ? eastl::make_pair(b, a) : eastl::make_pair(a, b);
}
...
template <typename T, typename Compare>
MUDA_THREAD_ONLY eastl::pair<const T&, const T&> minmax(const T& a, const T& b, Compare compare)
{
...
template <typename T>
MUDA_THREAD_ONLY eastl::pair<T, T> minmax(std::initializer_list<T> ilist)
{
...
MUDA_THREAD_ONLY eastl::pair<T, T> minmax(std::initializer_list<T> ilist, Compare compare)
{
    typedef typename std::initializer_list<T>::iterator iterator_type;
    eastl::pair<iterator_type, iterator_type>           iteratorPair =
...
template <typename T>
MUDA_THREAD_ONLY inline T&& median_impl(T&& a, T&& b, T&& c)
{
    if(eastl::less<T>()(a, b))
    {
        if(eastl::less<T>()(b, c))
...
///
template <typename T>
MUDA_THREAD_ONLY inline const T& median(const T& a, const T& b, const T& c)
{
...
///
template <typename T>
MUDA_THREAD_ONLY inline T&& median(T&& a, T&& b, T&& c)
{
    return eastl::forward<T>(
        median_impl(eastl::forward<T>(a), eastl::forward<T>(b), eastl::forward<T>(c)));
}


template <typename T, typename Compare>
MUDA_THREAD_ONLY inline T&& median_impl(T&& a, T&& b, T&& c, Compare compare)
{
    if(compare(a, b))
    {
        if(compare(b, c))
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY inline const T& median(const T& a, const T& b, const T& c, Compare compare)
{
...
///
template <typename T, typename Compare>
MUDA_THREAD_ONLY inline T&& median(T&& a, T&& b, T&& c, Compare compare)
{
...
MUDA_THREAD_ONLY inline bool all_of(InputIterator first, InputIterator last, Predicate p)
{
...
///
template <typename InputIterator, typename Predicate>
MUDA_THREAD_ONLY inline bool any_of(InputIterator first, InputIterator last, Predicate p)
{
    for(; first != last; ++first)
    {
        if(p(*first))
...
///
template <typename InputIterator, typename Predicate>
MUDA_THREAD_ONLY inline bool none_of(InputIterator first, InputIterator last, Predicate p)
{
    for(; first != last; ++first)
    {
        if(p(*first))
...
///
template <typename ForwardIterator>
MUDA_THREAD_ONLY inline ForwardIterator adjacent_find(ForwardIterator first, ForwardIterator last)
{
    if(first != last)
    {
        ForwardIterator i = first;
...
MUDA_THREAD_ONLY inline ForwardIterator adjacent_find(ForwardIterator first,
...
MUDA_THREAD_ONLY inline void shuffle(RandomAccessIterator           first,
...
MUDA_THREAD_ONLY inline void random_shuffle(RandomAccessIterator    first,
                                            RandomAccessIterator    last,
...
/// MUDA_THREAD_ONLY inline void random_shuffle(RandomAccessIterator first, RandomAccessIterator last)
/// {
///     for(RandomAccessIterator i = first + 1; i < last; ++i)
...
MUDA_THREAD_ONLY inline OutputIterator move_n_impl(InputIterator  first,
                                                   Size           n,
...
MUDA_THREAD_ONLY inline OutputIterator move_n_impl(RandomAccessIterator first,
                                                   Size                 n,
                                                   OutputIterator       result,
...
template <typename InputIterator, typename Size, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator move_n(InputIterator first, Size n, OutputIterator result)
{
...
///
template <typename InputIterator, typename Size, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator copy_n_impl(InputIterator  first,
                                                   Size           n,
                                                   OutputIterator result,
                                                   EASTL_ITC_NS::input_iterator_tag)
{
...
template <typename RandomAccessIterator, typename Size, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator copy_n_impl(RandomAccessIterator first,
                                                   Size                 n,
                                                   OutputIterator       result,
                                                   EASTL_ITC_NS::random_access_iterator_tag)
{
...
template <typename InputIterator, typename Size, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator copy_n(InputIterator first, Size n, OutputIterator result)
{
    typedef typename eastl::iterator_traits<InputIterator>::iterator_category IC;
...
MUDA_THREAD_ONLY inline OutputIterator copy_if(InputIterator  first,
                                               InputIterator  last,
                                               OutputIterator result,
                                               Predicate      predicate)
{
...
struct move_and_copy_backward_helper
{
    ...
    MUDA_THREAD_ONLY static BidirectionalIterator2 move_or_copy_backward(
        BidirectionalIterator1 first, BidirectionalIterator1 last, BidirectionalIterator2 resultEnd)
    {
        while(first != last)
            *--resultEnd = *--last;
...
{
    template <typename T>
    MUDA_THREAD_ONLY static T* move_or_copy_backward(const T* first, const T* last, T* resultEnd)
    {
        return (T*)memmove(resultEnd - (last - first),
                           first,
...
MUDA_THREAD_ONLY inline BidirectionalIterator2 move_and_copy_backward_chooser(
    BidirectionalIterator1 first, BidirectionalIterator1 last, BidirectionalIterator2 resultEnd)
{
    typedef typename eastl::iterator_traits<BidirectionalIterator1>::iterator_category IIC;

    const bool canBeMemmoved =
        internal::can_be_memmoved_helper<BidirectionalIterator1, BidirectionalIterator2>::value;

    return eastl::move_and_copy_backward_helper<IIC, isMove, canBeMemmoved>::move_or_copy_backward(
        first, last, resultEnd);  // Need to chose based on the input iterator tag and not the output iterator tag, because containers accept input ranges of iterator types different than self.
}
...
template <bool isMove, typename BidirectionalIterator1, typename BidirectionalIterator2>
MUDA_THREAD_ONLY inline BidirectionalIterator2 move_and_copy_backward_unwrapper(
    BidirectionalIterator1 first, BidirectionalIterator1 last, BidirectionalIterator2 resultEnd)
{
    return BidirectionalIterator2(eastl::move_and_copy_backward_chooser<isMove>(
        eastl::unwrap_iterator(first),
        eastl::unwrap_iterator(last),
        eastl::unwrap_iterator(resultEnd)));  // Have to convert to BidirectionalIterator2 because result.base() could be a T*
}
...
///
template <typename BidirectionalIterator1, typename BidirectionalIterator2>
MUDA_THREAD_ONLY inline BidirectionalIterator2 move_backward(BidirectionalIterator1 first,
...
///
template <typename BidirectionalIterator1, typename BidirectionalIterator2>
MUDA_THREAD_ONLY inline BidirectionalIterator2 copy_backward(BidirectionalIterator1 first,
                                                             BidirectionalIterator1 last,
                                                             BidirectionalIterator2 resultEnd)
{
...
MUDA_THREAD_ONLY inline typename eastl::iterator_traits<InputIterator>::difference_type count(
...
///
template <typename InputIterator, typename Predicate>
MUDA_THREAD_ONLY inline typename eastl::iterator_traits<InputIterator>::difference_type count_if(
...
///
template <typename InputIterator, typename T>
MUDA_THREAD_ONLY inline InputIterator find(InputIterator first, InputIterator last, const T& value)
{
...
template <typename InputIterator, typename T, typename Predicate>
MUDA_THREAD_ONLY inline InputIterator find(InputIterator first,
                                           InputIterator last,
                                           const T&      value,
                                           Predicate     predicate)
{
...
///
template <typename InputIterator, typename Predicate>
MUDA_THREAD_ONLY inline InputIterator find_if(InputIterator first, InputIterator last, Predicate predicate)
{
...
///
template <typename InputIterator, typename Predicate>
MUDA_THREAD_ONLY inline InputIterator find_if_not(InputIterator first,
                                                  InputIterator last,
                                                  Predicate     predicate)
{
    for(; first != last; ++first)
...
MUDA_THREAD_ONLY inline ForwardIterator1 find_first_of(ForwardIterator1 first1,
...
MUDA_THREAD_ONLY inline ForwardIterator1 find_first_not_of(ForwardIterator1 first1,
                                                           ForwardIterator1 last1,
                                                           ForwardIterator2 first2,
                                                           ForwardIterator2 last2)
{
                                                           ...
                                                           BinaryPredicate predicate)
{
    ...
    for(; first1 != last1; ++first1)
    {
        if(eastl::find_if(first2, last2, eastl::bind1st<BinaryPredicate, value_type>(predicate, *first1))
           == last2)
            break;
    }
...
MUDA_THREAD_ONLY inline BidirectionalIterator1 find_last_of(BidirectionalIterator1 first1,
                                                            ...
                                                            BinaryPredicate predicate)
{
    ...
    if((first1 != last1) && (first2 != last2))
    {
        ...
        while((--it1 != first1)
              && (eastl::find_if(first2, last2, eastl::bind1st<BinaryPredicate, value_type>(predicate, *it1))
                  == last2))
            ;  // Do nothing
...
template <class BidirectionalIterator1, class ForwardIterator2>
MUDA_THREAD_ONLY inline BidirectionalIterator1 find_last_not_of(BidirectionalIterator1 first1,
                                                                BidirectionalIterator1 last1,
                                                                ForwardIterator2 first2,
                                                                ForwardIterator2 last2)
{
...
MUDA_THREAD_ONLY inline Function for_each(InputIterator first, InputIterator last, Function function)
{
    for(; first != last; ++first)
        function(*first);
    return function;
...
MUDA_THREAD_ONLY EA_CPP14_CONSTEXPR inline InputIterator for_each_n(InputIterator first,
                                                                    Size n,
                                                                    Function function)
{
...
MUDA_THREAD_ONLY inline void generate(ForwardIterator first, ForwardIterator last, Generator generator)
{
...
MUDA_THREAD_ONLY inline OutputIterator generate_n(OutputIterator first, Size n, Generator generator)
{
    for(; n > 0; --n, ++first)
        *first = generator();
    return first;
...
MUDA_THREAD_ONLY inline OutputIterator transform(InputIterator  first,
                                                 InputIterator  last,
                                                 OutputIterator result,
...
MUDA_THREAD_ONLY inline OutputIterator transform(InputIterator1 first1,
...
MUDA_THREAD_ONLY EA_CPP14_CONSTEXPR inline bool equal(InputIterator1 first1,
                                                      InputIterator1 last1,
                                                      InputIterator2 first2)
{
...
MUDA_THREAD_ONLY inline bool equal(InputIterator1  first1,
                                   InputIterator1  last1,
                                   InputIterator2  first2,
                                   BinaryPredicate predicate)
{
...
///
template <typename InputIterator1, typename InputIterator2>
MUDA_THREAD_ONLY bool identical(InputIterator1 first1,
                               InputIterator1 last1,
                               InputIterator2 first2,
...
///
template <typename InputIterator1, typename InputIterator2, typename BinaryPredicate>
MUDA_THREAD_ONLY inline bool identical(InputIterator1  first1,
                                       InputIterator1  last1,
                                       InputIterator2  first2,
                                       InputIterator2  last2,
                                       BinaryPredicate predicate)
...
///
template <typename InputIterator1, typename InputIterator2>
MUDA_THREAD_ONLY inline bool lexicographical_compare(InputIterator1 first1,
                                                     InputIterator1 last1,
                                                     InputIterator2 first2,
                                                     InputIterator2 last2)
{
...
MUDA_THREAD_ONLY inline bool  // Specialization for const char*.
...
MUDA_THREAD_ONLY inline bool  // Specialization for char*.
...
MUDA_THREAD_ONLY inline bool  // Specialization for const unsigned char*.
...
MUDA_THREAD_ONLY inline bool  // Specialization for unsigned char*.
lexicographical_compare(unsigned char* first1,
                        unsigned char* last1,
...
MUDA_THREAD_ONLY inline bool  // Specialization for const signed char*.
lexicographical_compare(const signed char* first1,
...
MUDA_THREAD_ONLY inline bool  // Specialization for signed char*.
...
///
template <typename InputIterator1, typename InputIterator2, typename Compare>
MUDA_THREAD_ONLY constexpr auto lexicographical_compare_three_way(InputIterator1 first1,
                                                                  InputIterator1 last1,
                                                                  InputIterator2 first2,
                                                                  InputIterator2 last2,
                                                                  Compare compare)
...
MUDA_THREAD_ONLY inline eastl::pair<InputIterator1, InputIterator2> mismatch(
...
MUDA_THREAD_ONLY inline ForwardIterator lower_bound(ForwardIterator first,
                                                    ForwardIterator last,
                                                    const T&        value)
{
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline ForwardIterator upper_bound(ForwardIterator first,
                                                    ForwardIterator last,
                                                    const T&        value)
{
    typedef typename eastl::iterator_traits<ForwardIterator>::difference_type DifferenceType;
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline pair<ForwardIterator, ForwardIterator> equal_range(
...
template <typename ForwardIterator, typename T, typename Compare>
MUDA_THREAD_ONLY inline pair<ForwardIterator, ForwardIterator> equal_range(
    ForwardIterator first, ForwardIterator last, const T& value, Compare compare)
{
    typedef pair<ForwardIterator, ForwardIterator> ResultType;
    typedef typename eastl::iterator_traits<ForwardIterator>::difference_type DifferenceType;
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline void replace(ForwardIterator first,
                                     ForwardIterator last,
                                     const T&        old_value,
                                     const T&        new_value)
{
...
MUDA_THREAD_ONLY inline void replace_if(ForwardIterator first,
                                        ForwardIterator last,
                                        Predicate       predicate,
                                        const T&        new_value)
{
...
MUDA_THREAD_ONLY inline OutputIterator remove_copy(InputIterator  first,
                                                   InputIterator  last,
                                                   OutputIterator result,
                                                   const T&       value)
{
...
///
template <typename InputIterator, typename OutputIterator, typename Predicate>
MUDA_THREAD_ONLY inline OutputIterator remove_copy_if(InputIterator  first,
                                                      InputIterator  last,
                                                      OutputIterator result,
                                                      Predicate      predicate)
{
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline ForwardIterator remove(ForwardIterator first,
                                               ForwardIterator last,
                                               const T&        value)
{
...
MUDA_THREAD_ONLY inline ForwardIterator remove_if(ForwardIterator first,
                                                  ForwardIterator last,
                                                  Predicate       predicate)
{
...
MUDA_THREAD_ONLY inline ForwardIterator apply_and_remove_if(ForwardIterator first,
                                                            ForwardIterator last,
                                                            Function  function,
                                                            Predicate predicate)
{
...
MUDA_THREAD_ONLY inline ForwardIterator apply_and_remove(ForwardIterator first,
                                                         ForwardIterator last,
                                                         Function function,
                                                         const T& value)
{
...
///
template <typename InputIterator, typename OutputIterator, typename T>
MUDA_THREAD_ONLY inline OutputIterator replace_copy(InputIterator  first,
                                                    InputIterator  last,
                                                    OutputIterator result,
                                                    const T&       old_value,
                                                    const T&       new_value)
...
MUDA_THREAD_ONLY inline OutputIterator replace_copy_if(InputIterator  first,
                                                       InputIterator  last,
                                                       OutputIterator result,
                                                       Predicate      predicate,
                                                       const T&       new_value)
...
MUDA_THREAD_ONLY inline void reverse_impl(BidirectionalIterator first,
...
template <typename RandomAccessIterator>
MUDA_THREAD_ONLY inline void reverse_impl(RandomAccessIterator first,
                                          RandomAccessIterator last,
                                          EASTL_ITC_NS::random_access_iterator_tag)
{
    if(first != last)
...
///
template <typename BidirectionalIterator>
MUDA_THREAD_ONLY inline void reverse(BidirectionalIterator first, BidirectionalIterator last)
{
...
MUDA_THREAD_ONLY inline OutputIterator reverse_copy(BidirectionalIterator first,
                                                    BidirectionalIterator last,
                                                    OutputIterator result)
{
...
///
template <typename ForwardIterator1, typename ForwardIterator2>
MUDA_THREAD_ONLY inline ForwardIterator1 search(ForwardIterator1 first1,
                                                ForwardIterator1 last1,
                                                ForwardIterator2 first2,
                                                ForwardIterator2 last2)
{
...
MUDA_THREAD_ONLY inline ForwardIterator  // Generic implementation.
...
MUDA_THREAD_ONLY inline RandomAccessIterator  // Random access iterator implementation. Much faster than generic implementation.
search_n_impl(RandomAccessIterator first,
              RandomAccessIterator last,
              Size                 count,
              const T&             value,
              EASTL_ITC_NS::random_access_iterator_tag)
...
///
template <typename ForwardIterator, typename Size, typename T>
MUDA_THREAD_ONLY inline ForwardIterator search_n(ForwardIterator first,
                                                 ForwardIterator last,
                                                 Size            count,
                                                 const T&        value)
{
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline bool binary_search(ForwardIterator first,
                                           ForwardIterator last,
                                           const T&        value)
{
                                           ...
                                           Compare         compare)
{
    // To do: This can be made slightly faster by not using lower_bound.
    ForwardIterator i(
        eastl::lower_bound<ForwardIterator, T, Compare>(first, last, value, compare));
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline ForwardIterator binary_search_i(ForwardIterator first,
                                                        ForwardIterator last,
                                                        const T&        value)
{
    // To do: This can be made slightly faster by not using lower_bound.
...
///
template <typename ForwardIterator>
MUDA_THREAD_ONLY inline ForwardIterator unique(ForwardIterator first, ForwardIterator last)
{
...
///
template <typename ForwardIterator, typename BinaryPredicate>
MUDA_THREAD_ONLY inline ForwardIterator unique(ForwardIterator first,
                                               ForwardIterator last,
                                               BinaryPredicate predicate)
{
...
//
template <typename ForwardIterator1, typename ForwardIterator2>
MUDA_THREAD_ONLY inline ForwardIterator1 find_end_impl(ForwardIterator1 first1,
                                                       ForwardIterator1 last1,
                                                       ForwardIterator2 first2,
                                                       ForwardIterator2 last2,
...
template <typename BidirectionalIterator1, typename BidirectionalIterator2>
MUDA_THREAD_ONLY inline BidirectionalIterator1 find_end_impl(
    ...
    EASTL_ITC_NS::bidirectional_iterator_tag)
{
    ...
    reverse_iterator1 rresult(eastl::search(reverse_iterator1(last1),
...
///
template <typename ForwardIterator1, typename ForwardIterator2>
MUDA_THREAD_ONLY inline ForwardIterator1 find_end(ForwardIterator1 first1,
                                                  ForwardIterator1 last1,
                                                  ForwardIterator2 first2,
                                                  ForwardIterator2 last2)
{
...
MUDA_THREAD_ONLY inline OutputIterator set_difference(InputIterator1 first1,
                                                      InputIterator1 last1,
                                                      InputIterator2 first2,
                                                      InputIterator2 last2,
                                                      OutputIterator result)
...
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator, typename Compare>
MUDA_THREAD_ONLY inline void set_difference_2(InputIterator1 first1,
                                              InputIterator1 last1,
                                              InputIterator2 first2,
                                              InputIterator2 last2,
...
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator set_symmetric_difference(InputIterator1 first1,
                                                                InputIterator1 last1,
                                                                InputIterator2 first2,
                                                                InputIterator2 last2,
                                                                OutputIterator result)
...
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator set_intersection(InputIterator1 first1,
                                                        InputIterator1 last1,
                                                        InputIterator2 first2,
                                                        InputIterator2 last2,
                                                        OutputIterator result)
...
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator>
MUDA_THREAD_ONLY inline OutputIterator set_union(InputIterator1 first1,
                                                 InputIterator1 last1,
                                                 InputIterator2 first2,
                                                 InputIterator2 last2,
                                                 OutputIterator result)
...
/// Complexity: At most (2 * ((last1 - first1) + (last2 - first2)) - 1) comparisons.
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator1, typename OutputIterator2, typename OutputIterator3, typename Compare>
MUDA_THREAD_ONLY inline OutputIterator3 set_decomposition(InputIterator1 first1,
                                                          InputIterator1 last1,
                                                          InputIterator2 first2,
                                                          InputIterator2 last2,
...
///
template <typename InputIterator1, typename InputIterator2, typename OutputIterator1, typename OutputIterator2, typename OutputIterator3>
MUDA_THREAD_ONLY inline OutputIterator3 set_decomposition(InputIterator1 first1,
                                                          InputIterator1 last1,
                                                          InputIterator2 first2,
                                                          InputIterator2 last2,
                                                          ...
                                                          OutputIterator3 result3)
{
    return eastl::set_decomposition(
        first1, last1, first2, last2, result1, result2, result3, eastl::less<>{});
}
...
///
template <typename ForwardIterator1, typename ForwardIterator2>
MUDA_THREAD_ONLY inline bool is_permutation(ForwardIterator1 first1,
                                            ForwardIterator1 last1,
                                            ForwardIterator2 first2)
{
...
MUDA_THREAD_ONLY inline bool next_permutation(BidirectionalIterator first,
                                              BidirectionalIterator last,
                                              Compare               compare)
{
...
{
    template <typename ForwardIterator>
    MUDA_THREAD_ONLY inline ForwardIterator rotate_general_impl(ForwardIterator first,
    ...
    template <typename ForwardIterator>
    MUDA_THREAD_ONLY inline ForwardIterator move_rotate_left_by_one(ForwardIterator first,
                                                                    ForwardIterator last)
    {
        typedef typename eastl::iterator_traits<ForwardIterator>::value_type value_type;
    ...
    template <typename BidirectionalIterator>
    MUDA_THREAD_ONLY inline BidirectionalIterator move_rotate_right_by_one(
        BidirectionalIterator first, BidirectionalIterator last)
    {
        ...
        BidirectionalIterator result =
            eastl::move_backward(first, beforeLast, last);  // Note that while our template type is BidirectionalIterator, if the actual
    ...
    {
        template <typename ForwardIterator>
        MUDA_THREAD_ONLY static ForwardIterator rotate_impl(ForwardIterator first,
                                                            ForwardIterator middle,
                                                            ForwardIterator last)
        {
    ...
    {
        template <typename BidirectionalIterator>
        MUDA_THREAD_ONLY static BidirectionalIterator rotate_impl(BidirectionalIterator first,
    ...
    MUDA_THREAD_ONLY inline Integer greatest_common_divisor(Integer x, Integer y)
    {
        do
        {
            Integer t = (x % y);
    ...
    struct rotate_helper<EASTL_ITC_NS::random_access_iterator_tag, false>
    {
        ...
        template <typename RandomAccessIterator>
        MUDA_THREAD_ONLY static RandomAccessIterator rotate_impl(RandomAccessIterator first,
    ...
    struct rotate_helper<EASTL_ITC_NS::random_access_iterator_tag, true>
    {
                                                                 ...
                                                                 RandomAccessIterator last)
        {
            ...
            if((last - first) < 32)  // For small ranges rotate_general_impl is faster.
                return Internal::rotate_general_impl(first, middle, last);
            return Internal::rotate_helper<EASTL_ITC_NS::random_access_iterator_tag, false>::rotate_impl(
                first, middle, last);
        }
    };
...
template <typename ForwardIterator>
MUDA_THREAD_ONLY inline ForwardIterator rotate(ForwardIterator first,
                                               ForwardIterator middle,
                                               ForwardIterator last)
{
    if(middle != first)
    {
        if(middle != last)
        {
            ...
            return Internal::rotate_helper < IC,
                   eastl::is_trivially_move_assignable<value_type>::value
                       ...
                       eastl::is_scalar<value_type>::value
...
MUDA_THREAD_ONLY inline OutputIterator rotate_copy(ForwardIterator first,
                                                   ForwardIterator middle,
                                                   ForwardIterator last,
                                                   OutputIterator  result)
{
...
MUDA_THREAD_ONLY EA_CONSTEXPR const T& clamp(const T& v, const T& lo, const T& hi, Compare comp)
{
    // code collapsed to a single line due to constexpr requirements
    return [&] { EASTL_ASSERT(!comp(hi, lo)); }(), comp(v, lo) ? lo :
                                                   comp(hi, v) ? hi :
                                                                 v;
}

template <class T>
MUDA_THREAD_ONLY EA_CONSTEXPR const T& clamp(const T& v, const T& lo, const T& hi)
{
