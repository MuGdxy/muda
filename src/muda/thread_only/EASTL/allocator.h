...
{
  public:
    MUDA_THREAD_ONLY EASTL_ALLOCATOR_EXPLICIT
    allocator(const char* pName = EASTL_NAME_VAL(EASTL_ALLOCATOR_DEFAULT_NAME));
    MUDA_THREAD_ONLY allocator(const allocator& x);
    MUDA_THREAD_ONLY allocator(const allocator& x, const char* pName);

    MUDA_THREAD_ONLY allocator& operator=(const allocator& x);
    ...
    MUDA_THREAD_ONLY const char* get_name() const;
    MUDA_THREAD_ONLY void        set_name(const char* pName);
...
MUDA_THREAD_ONLY bool operator==(const allocator& a, const allocator& b);
...
{
  public:
    MUDA_THREAD_ONLY EASTL_ALLOCATOR_EXPLICIT dummy_allocator(const char* = NULL)
    {
    }
    MUDA_THREAD_ONLY dummy_allocator(const dummy_allocator&) {}
    MUDA_THREAD_ONLY dummy_allocator(const dummy_allocator&, const char*) {}

    MUDA_THREAD_ONLY dummy_allocator& operator=(const dummy_allocator&)
    {
        return *this;
    }

    MUDA_THREAD_ONLY void* allocate(size_t, int = 0) { return NULL; }
    MUDA_THREAD_ONLY void* allocate(size_t, size_t, size_t, int = 0)
    {
        return NULL;
    }
    MUDA_THREAD_ONLY void deallocate(void*, size_t) {}

    MUDA_THREAD_ONLY const char* get_name() const { return ""; }
    MUDA_THREAD_ONLY void        set_name(const char*) {}
};

MUDA_THREAD_ONLY inline bool operator==(const dummy_allocator&, const dummy_allocator&)
{
    return true;
}
#if !defined(EA_COMPILER_HAS_THREE_WAY_COMPARISON)
...
MUDA_THREAD_ONLY EASTL_API allocator* GetDefaultAllocator();
MUDA_THREAD_ONLY EASTL_API allocator* SetDefaultAllocator(allocator* pAllocator);
...
MUDA_THREAD_ONLY Allocator* get_default_allocator(const Allocator*);
...
///
MUDA_THREAD_ONLY void* default_allocfreemethod(size_t n, void* pBuffer, void* /*pContext*/);
...
///
template <typename Allocator>
MUDA_THREAD_ONLY void* allocate_memory(Allocator& a, size_t n, size_t alignment, size_t alignmentOffset);
...
namespace eastl
{
MUDA_THREAD_ONLY inline allocator::allocator(const char* EASTL_NAME(pName))
{
#if EASTL_NAME_ENABLED
...
MUDA_THREAD_ONLY inline allocator::allocator(const allocator& EASTL_NAME(alloc))
{
#if EASTL_NAME_ENABLED
    mpName = alloc.mpName;
#endif
...
MUDA_THREAD_ONLY inline allocator::allocator(const allocator&, const char* EASTL_NAME(pName))
{
#if EASTL_NAME_ENABLED
    mpName = pName ? pName : EASTL_ALLOCATOR_DEFAULT_NAME;
#endif
...
MUDA_THREAD_ONLY inline allocator& allocator::operator=(const allocator& EASTL_NAME(alloc))
{
#if EASTL_NAME_ENABLED
    mpName = alloc.mpName;
#endif
...
MUDA_THREAD_ONLY inline const char* allocator::get_name() const
{
#if EASTL_NAME_ENABLED
    return mpName;
#else
...
MUDA_THREAD_ONLY inline void allocator::set_name(const char* EASTL_NAME(pName))
{
#if EASTL_NAME_ENABLED
    mpName = pName;
#endif
...
MUDA_THREAD_ONLY inline void* allocator::allocate(size_t n, int flags)
{
#if EASTL_NAME_ENABLED
#define pName mpName
#else
...
MUDA_THREAD_ONLY inline void* allocator::allocate(size_t n, size_t alignment, size_t offset, int flags)
{
#if EASTL_DLL
    ...
    void* pAligned = (void*)(((uintptr_t)pPlusPointerSize + adjustedAlignment - 1)
                             & ~(adjustedAlignment - 1));
...
MUDA_THREAD_ONLY inline void allocator::deallocate(void* p, size_t)
{
#if EASTL_DLL
    if(p != nullptr)
    {
...
MUDA_THREAD_ONLY inline bool operator==(const allocator&, const allocator&)
{
...
template <typename Allocator>
MUDA_THREAD_ONLY inline Allocator* get_default_allocator(const Allocator*)
{
...
MUDA_THREAD_ONLY inline EASTLAllocatorType* get_default_allocator(const EASTLAllocatorType*)
{
...
MUDA_THREAD_ONLY inline void* default_allocfreemethod(size_t n, void* pBuffer, void* /*pContext*/)
{
...
///
template <typename Allocator>
MUDA_THREAD_ONLY inline void* allocate_memory(Allocator& a, size_t n, size_t alignment, size_t alignmentOffset)
{
    void* result;
