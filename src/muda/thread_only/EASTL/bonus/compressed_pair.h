...
template <typename T>
MUDA_THREAD_ONLY inline void cp_swap(T& t1, T& t2)
{
    T tTemp = t1;
    t1      = t2;
    t2      = tTemp;
...
class compressed_pair_imp<T1, T2, 0>
{
  public:
    ...
    MUDA_THREAD_ONLY compressed_pair_imp() {}

    MUDA_THREAD_ONLY compressed_pair_imp(first_param_type x, second_param_type y)
        : mFirst(x)
        , mSecond(y)
    {
    }

    MUDA_THREAD_ONLY compressed_pair_imp(first_param_type x)
        : mFirst(x)
    {
    }

    MUDA_THREAD_ONLY compressed_pair_imp(second_param_type y)
        : mSecond(y)
    {
    }

    MUDA_THREAD_ONLY first_reference first() { return mFirst; }
    MUDA_THREAD_ONLY first_const_reference first() const { return mFirst; }

    MUDA_THREAD_ONLY second_reference second() { return mSecond; }
    MUDA_THREAD_ONLY second_const_reference second() const { return mSecond; }

    MUDA_THREAD_ONLY void swap(compressed_pair<T1, T2>& y)
    {
...
class compressed_pair_imp<T1, T2, 1> : private T1
{
  public:
    ...
    MUDA_THREAD_ONLY first_reference first() { return *this; }
    MUDA_THREAD_ONLY first_const_reference first() const { return *this; }
...
class compressed_pair_imp<T1, T2, 2> : private T2
{
  public:
    ...
    MUDA_THREAD_ONLY second_reference second() { return *this; }
    MUDA_THREAD_ONLY second_const_reference second() const { return *this; }
...
class compressed_pair_imp<T1, T2, 3> : private T1, private T2
{
  public:
    ...
    MUDA_THREAD_ONLY void swap(compressed_pair<T1, T2>&) {}
};
...
class compressed_pair_imp<T1, T2, 4> : private T1
{
  public:
   ...
   MUDA_THREAD_ONLY compressed_pair_imp() {}
    ...
    MUDA_THREAD_ONLY compressed_pair_imp(first_param_type x, second_param_type)
        : first_type(x)
    {
    }
...
class compressed_pair
    : private compressed_pair_imp<
          T1,
          T2,
          compressed_pair_switch<T1, T2, is_same<typename remove_cv<T1>::type, typename remove_cv<T2>::type>::value, is_empty<T1>::value, is_empty<T2>::value>::value>
{
  private:
  ...
  public:
    ...
    MUDA_THREAD_ONLY compressed_pair()
        : base()
    {
    }
    MUDA_THREAD_ONLY compressed_pair(first_param_type x, second_param_type y)
        : base(x, y)
    {
    }
    MUDA_THREAD_ONLY explicit compressed_pair(first_param_type x)
        : base(x)
    {
    }
    MUDA_THREAD_ONLY explicit compressed_pair(second_param_type y)
        : base(y)
    {
    }

    MUDA_THREAD_ONLY first_reference first() { return base::first(); }
    MUDA_THREAD_ONLY first_const_reference first() const
    {
        return base::first();
    }

    MUDA_THREAD_ONLY second_reference second() { return base::second(); }
    MUDA_THREAD_ONLY second_const_reference second() const
    {
        return base::second();
    }

    MUDA_THREAD_ONLY void swap(compressed_pair& y) { base::swap(y); }
};
...
class compressed_pair<T, T>
    : private compressed_pair_imp<
          T,
          T,
          compressed_pair_switch<T, T, is_same<typename remove_cv<T>::type, typename remove_cv<T>::type>::value, is_empty<T>::value, is_empty<T>::value>::value>
{
  private:
    typedef compressed_pair_imp<
        T,
  ...
  public:
    ...
    MUDA_THREAD_ONLY void swap(compressed_pair<T, T>& y) { base::swap(y); }
};


template <typename T1, typename T2>
MUDA_THREAD_ONLY inline void swap(compressed_pair<T1, T2>& x, compressed_pair<T1, T2>& y)
{
    x.swap(y);
}
