...
struct fill_imp
{
    ...
    MUDA_THREAD_ONLY static void do_fill(ForwardIterator first, ForwardIterator last, const T& value)
    {
...
///
template <typename ForwardIterator, typename T>
MUDA_THREAD_ONLY inline void fill(ForwardIterator first, ForwardIterator last, const T& value)
{
...
struct fill_n_imp
{
    ...
    MUDA_THREAD_ONLY static OutputIterator do_fill(OutputIterator first, Size n, const T& value)
    {
        for(; n-- > 0; ++first)
            *first = value;
        return first;
...
///
template <typename OutputIterator, typename Size, typename T>
MUDA_THREAD_ONLY OutputIterator fill_n(OutputIterator first, Size n, const T& value)
{
    return eastl::fill_n_imp<is_scalar<T>::value>::do_fill(first, n, value);
}

//template <typename Size>
//   MUDA_THREAD_ONLY inline char* fill_n(char* first, Size n, const char& c)
//{
//	return (char*)memset(first, (char)c, (size_t)n) + n;
//}

//template <typename Size>
//   MUDA_THREAD_ONLY inline unsigned char* fill_n(unsigned char*       first,
//                                                 Size                 n,
...
//template <typename Size>
//   MUDA_THREAD_ONLY inline signed char* fill_n(signed char* first, Size n, const signed char& c)
//{
