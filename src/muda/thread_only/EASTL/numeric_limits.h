...
namespace eastl
{
	...
	public:
		...
		MUDA_THREAD_ONLY static value_type min()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type max()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type lowest()
			{ return min(); }

		MUDA_THREAD_ONLY static value_type epsilon()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type round_error()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type denorm_min()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type infinity()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type quiet_NaN()
			{ return value_type(0); }

		MUDA_THREAD_ONLY static value_type signaling_NaN()
			{ return value_type(0); }
	};
	...
	struct numeric_limits<bool>
	{
		...
		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type min() 
			{ return false; }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type max()
			{ return true; }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type lowest() 
			{ return false; }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type epsilon() 
			{ return false; }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type round_error() 
			{ return false; }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type infinity() 
			{ return value_type(); }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type quiet_NaN() 
			{ return value_type(); }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type signaling_NaN()
			{ return value_type(); }

		MUDA_THREAD_ONLY static EA_CONSTEXPR value_type denorm_min() 
			{ return value_type(); }
	};
