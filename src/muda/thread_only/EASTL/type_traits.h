...
namespace eastl
{
	...
	struct integral_constant
	{
		...
		MUDA_THREAD_ONLY EA_CONSTEXPR operator value_type() const EA_NOEXCEPT
        {
            return value;
        }
        MUDA_THREAD_ONLY EA_CONSTEXPR value_type operator()() const EA_NOEXCEPT
        {
            return value;
        }
	};
	...
	struct argument_sink
	{
        ...
        MUDA_THREAD_ONLY argument_sink(Args&&...)
        {
        }
	};
