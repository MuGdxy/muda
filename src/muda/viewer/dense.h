...
template <typename T>
class DenseND<T, 0> : public ViewBase<DenseND<T, 0>>
{
    T* m_data;
...
template <typename T>
class DenseND<T, 1> : public ViewBase<DenseND<T, 1>>
{
    T*                    m_data;
...
template <typename T>
class DenseND<T, 2> : public ViewBase<DenseND<T, 2>>
{
    T*                    m_data;
...
template <typename T>
class DenseND<T, 3> : public ViewBase<DenseND<T, 3>>
{
    T*                    m_data;
