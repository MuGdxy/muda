...
#include "DISTANCE_UNCLASSIFIED.h"
                                ...
                                T&                     toc)
{
    ...
    deb0 -= mov;
    deb1 -= mov;
    T maxDispMag = sqrt(max(dea0.squaredNorm(), dea1.squaredNorm()))
                   + sqrt(max(deb0.squaredNorm(), deb1.squaredNorm()));
    if(maxDispMag == 0)
    {
        return false;
    }
                                 ...
                                 T&                     toc)
{
    ...
    de1 -= mov;
    dp -= mov;
    T maxDispMag = dp.norm() + sqrt(max(de0.squaredNorm(), de1.squaredNorm()));
    if(maxDispMag == 0)
    {
        return false;
    }
