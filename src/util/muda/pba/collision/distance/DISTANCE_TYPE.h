...
MUDA_GENERIC int Point_Edge_Distance_Type(const Eigen::Matrix<T, dim, 1>& p, 
...
template <class T>
MUDA_GENERIC int Point_Triangle_Distance_Type(
...
template <class T>
MUDA_GENERIC int Edge_Edge_Distance_Type(
