...
template <class T>
MUDA_GENERIC void Edge_Edge_Cross_Norm2(
...
template <class T>
MUDA_GENERIC void g_EECN2(T v01, T v02, T v03, T v11,
...
template <class T>
MUDA_GENERIC void Edge_Edge_Cross_Norm2_Gradient(
    const Eigen::Matrix<T, 3, 1>& ea0,
    const Eigen::Matrix<T, 3, 1>& ea1,
    const Eigen::Matrix<T, 3, 1>& eb0,
    const Eigen::Matrix<T, 3, 1>& eb1,
...
template <class T>
MUDA_GENERIC void H_EECN2(T v01, T v02, T v03, T v11,
...
template <class T>
MUDA_GENERIC void Edge_Edge_Cross_Norm2_Hessian(
    const Eigen::Matrix<T, 3, 1>& ea0,
    const Eigen::Matrix<T, 3, 1>& ea1,
    const Eigen::Matrix<T, 3, 1>& eb0,
    const Eigen::Matrix<T, 3, 1>& eb1,
...
template <class T>
MUDA_GENERIC void derivTest_EECross(MUDA_GENERIC void)
{
...
template <class T>
MUDA_GENERIC void Edge_Edge_Mollifier(
    const Eigen::Matrix<T, 3, 1>& ea0,
    const Eigen::Matrix<T, 3, 1>& ea1,
    const Eigen::Matrix<T, 3, 1>& eb0,
    const Eigen::Matrix<T, 3, 1>& eb1,
...
template <class T>
MUDA_GENERIC void Edge_Edge_Mollifier_Gradient(
    const Eigen::Matrix<T, 3, 1>& ea0,
    const Eigen::Matrix<T, 3, 1>& ea1,
    const Eigen::Matrix<T, 3, 1>& eb0,
    const Eigen::Matrix<T, 3, 1>& eb1,
...
template <class T>
MUDA_GENERIC void Edge_Edge_Mollifier_Hessian(
    const Eigen::Matrix<T, 3, 1>& ea0,
    const Eigen::Matrix<T, 3, 1>& ea1,
    const Eigen::Matrix<T, 3, 1>& eb0,
    const Eigen::Matrix<T, 3, 1>& eb1,
...
template <class T>
MUDA_GENERIC void derivTest_e(T eps_x = 10.0)
{
    Eigen::Matrix<T, 3, 1> v[4];
    v[0] << 0.0, 0.0, 0.0;
    v[1] << 1.0, 0.1, 0.0;
...
template <class T>
MUDA_GENERIC void Edge_Edge_Mollifier_Threshold(
