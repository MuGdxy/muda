...
MUDA_GENERIC void Point_Point_Distance(const Eigen::Matrix<T, dim, 1>& a, 
...
template <class T, int dim>
MUDA_GENERIC void Point_Point_Distance_Gradient(const Eigen::Matrix<T, dim, 1>& a, 
    const Eigen::Matrix<T, dim, 1>& b, 
...
template <class T, int dim>
MUDA_GENERIC void Point_Point_Distance_Hessian(const Eigen::Matrix<T, dim, 1>& a, 
    const Eigen::Matrix<T, dim, 1>& b, 
