...
template <class T>
MUDA_GENERIC void Point_Triangle_Distance(
...
template <class T>
MUDA_GENERIC void g_PT(T v01, T v02, T v03, T v11, T v12, T v13,
...
template <class T>
MUDA_GENERIC void Point_Triangle_Distance_Gradient(
    const Eigen::Matrix<T, 3, 1>& p,
    const Eigen::Matrix<T, 3, 1>& t0,
    const Eigen::Matrix<T, 3, 1>& t1,
    const Eigen::Matrix<T, 3, 1>& t2,
...
template <class T>
MUDA_GENERIC void H_PT(T v01, T v02, T v03, T v11, T v12, T v13,
    T v21, T v22, T v23, T v31, T v32, T v33,
    T H[144])
{
    T t11;
...
template <class T>
MUDA_GENERIC void Point_Triangle_Distance_Hessian(
    const Eigen::Matrix<T, 3, 1>& p,
    const Eigen::Matrix<T, 3, 1>& t0,
    const Eigen::Matrix<T, 3, 1>& t1,
    const Eigen::Matrix<T, 3, 1>& t2,
